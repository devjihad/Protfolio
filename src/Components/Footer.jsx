    ...
    return (
        <div className='pt-16  pb-24'>
            ...
            <div className='md:w-1/2 pt-10  '>
                <input type="email" name="" id="" placeholder='Enter your email'  className='px-3 py-1.25 md:px-5 md:py-3 rounded-xl text-xl bg-gray-700 hover:border-2 md:mr-7 '/>
                <button className='bg-linear-to-r/decreasing from-zinc-500 to-blue-300px-3 py-1.25 md:px-5 md:py-3 rounded-lg font-semibold transition duration-300 hover:scale-110  cursor-pointer text-xl '>Subscribe</button>
            </div>
            </div>
            <hr className='my-5'/>
