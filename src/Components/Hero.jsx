    ...
    return (
        <div className='flex justify-between py-20'>
            ...
            <div className='w-1/2 mt-5'>
                ...
                <div className='mt-8'>
                    <button className='bg-linear-to-r/decreasing from-zinc-500 to-blue-300   px-5 py-2 rounded-lg font-medium transition duration-300 hover:scale-110 mr-6 cursor-pointer'>Connect with me</button>
