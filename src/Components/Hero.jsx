    ...
    return (
        <div className='flex flex-col-reverse gap-5 lg:gap-0  md:flex-row justify-between py-10 md:py-20' id='hero'>
            ...
            <div className='w-full md:w-2/3 lg:w-1/2 mt-5'>
                ...
                <p className='font-medium'>FrontendDeveloper with 1.5+ years of experience building responsive and high-performance web applications. Skilled in converting UI/UX designs (Figma/PSD) into functional websites and optimizing performance.</p>
                <div className='mt-8'>
