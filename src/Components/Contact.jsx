            ...
            <div className='w-1/2'>
                <form  onSubmit={onSubmit}>
                    <div className='flex flex-col mb-4'>
                        ...
                        <input type="text" name='name' placeholder='Enter your name' className='px-5 py-3 rounded-lg text-xl bg-gray-700' />
                    </div>
                    <div className='flex flex-col mb-4'>
                        <label htmlFor="" className='text-[16px] mb-2 '>Your Email</label>
                        <input type="email" name='email' placeholder='Enter your email'  className='px-5 py-3 rounded-lg text-xl bg-gray-700'/>
                    </div>
                    <div className='flex flex-col mb-4'>
                        <label htmlFor="" className='text-[16px] mb-2 '>Write your message here</label>
                        <textarea name="message" id="" placeholder='Enter your message' className='px-5 py-3 rounded-lg text-xl bg-gray-700 min-h-[200px]'></textarea>
                    </div>
